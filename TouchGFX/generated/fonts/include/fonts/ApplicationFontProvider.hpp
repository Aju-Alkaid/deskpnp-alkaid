...
struct Typography
{
    static const touchgfx::FontId NORMAL_HANDWRITE = 0;
    static const touchgfx::FontId REGULAR = 1;
};

struct TypographyFontIndex
{
    static const touchgfx::FontId NORMAL_HANDWRITE = 0; // comic_25_1bpp
    static const touchgfx::FontId REGULAR = 1;          // segoeui_23_1bpp
